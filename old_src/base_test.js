...
BaseTest = TestCase("base_test");

BaseTest.prototype.testInherits = function() {
...
BaseTest.prototype.testAddSingletonGetter = function() {
  var some = function() {};

  wr.addSingletonGetter(some);
